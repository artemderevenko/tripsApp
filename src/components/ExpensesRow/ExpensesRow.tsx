    ...
    <div className={styles['row']}>
      <div className={styles['type']}>
        <CustomSelect
          ...
          selectValue={useGetSelectOption(type, expenseCategory)}
          selectOptions={expenseCategory}
          onChange={(e) => changeSelect('type', e, typeSelect.onChange)}
        />
      </div>
      <div className={styles['description']}>
        <CustomInput
          ...
          onChange={(e) => changeInput('label', e, labelInput.onChange)}
